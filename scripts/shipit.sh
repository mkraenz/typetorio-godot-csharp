...
# windows TODO
# mkdir -p .build/linux
# /home/mirco/programming/gamedev/godot4/Godot_v4.2.2-stable_mono_linux_x86_64/Godot_v4.2.2-stable_mono_linux.x86_64 --export-release 'Windows' .build/windows/Typetorio.x86_64
